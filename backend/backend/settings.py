...
SECRET_KEY = 'django-insecure-6z@db_+=mcgx-4blzl5i%(p74w=*^rr^c2m$zwr8uy@se(l&$w'
...
SIMPLE_JWT = {
    ...
    'REFRESH_COOKIE_SECURE': False,  # Whether the auth cookies should be secure (https:// only).
    'REFRESH_COOKIE_HTTP_ONLY': False,  # Http only cookie flag.It's not fetch by javascript.
    'REFRESH_COOKIE_PATH': '/',  # The path of the auth cookie.
    'REFRESH_COOKIE_SAMESITE': 'Lax',
    # Whether to set the flag restricting cookie leaks on cross-site requests. This can be 'Lax', 'Strict', or None to disable the flag
}

AUTH_USER_MODEL = 'custom_auth.UserClass'
